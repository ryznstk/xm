...
git clone -b auto3 --depth 1 https://gitlab.com/blu96/kernel_xiaomi_sm8635.git kernel/xiaomi/sm8635
...
curl -LSs "https://raw.githubusercontent.com/ryznstk/ReSukiSU/refs/heads/susfs-ksud/kernel/setup.sh" | bash -s susfs-ksud
croot
